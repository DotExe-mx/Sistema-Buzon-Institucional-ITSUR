...
namespace SIS_QSF.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        {
            var departamento = from m in _context.Departaments
                              select m;

            if (!String.IsNullOrEmpty(searchString))
            {
                departamento = departamento.Where(s => s.Nombre.Contains(searchString));
            }
...
*/
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var departamento = await _context.Departaments
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var departamento = await _context.Departaments.FindAsync(id);
            if (departamento == null)
            {
                return NotFound();
            }
        ...
        {
            var departamento = await _context.Departaments.FindAsync(id);
            _context.Departaments.Remove(departamento);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
